...
All clients verify each Shadowchain block within the CLM system, but they
have no assurance that their order was actually included in the matchmaking
...
parently authenticated data structure to give users a receipt of proper
...
As is, the maker receives their premium all at once. However it may be
